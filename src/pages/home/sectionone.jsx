          ...
          <div className="flex flex-col justify-center items-center text-center h-full px-4 z-30 relative">
            ...
            <div className="relative top-16 xl:top-24 flex lg:flex-row flex-col gap-4 items-center justify-center">
              <ButtonComponent
                ...
                viewBox="0 0 64 64"
                text="View Github"
                additionalClasses="w-max text-gray-900 bg-white hover:bg-gray-100 border border-gray-200 font-medium rounded-lg text-md lg:px-3 lg:py-2 px-2.5 py-1.5 pe-4 text-center inline-flex items-center dark:bg-gray-800 dark:border-gray-700 dark:text-white dark:hover:bg-gray-700 lg:mt-8 space-x-2"
              />
              <ButtonComponent
                btnType="button"
